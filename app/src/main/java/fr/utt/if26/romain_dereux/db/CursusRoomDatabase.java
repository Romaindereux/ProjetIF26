...
@Database(entities = {Cursus.class, UE.class}, version = 7, exportSchema = false)
    ...
    private static RoomDatabase.Callback sRoomDatabaseCallback = new RoomDatabase.Callback() {
        ...
        public void onCreate(@NonNull SupportSQLiteDatabase db) {
            ...
            databaseWriteExecutor.execute(() -> {
                ...
                Cursus cursus = new Cursus("cursus1", "ISI", new ArrayList<>(),new ArrayList<>(),new ArrayList<>(),new ArrayList<>(),new ArrayList<>(), false);
                dao.insert(cursus);
                cursus = new Cursus("cursus2", "ISI", new ArrayList<>(),new ArrayList<>(),new ArrayList<>(),new ArrayList<>(),new ArrayList<>(), false);
                dao.insert(cursus);
